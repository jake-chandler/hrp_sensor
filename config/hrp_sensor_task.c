 ...
 *
 * @brief Heart Rate Sensor Profile demo task
 *
...
__RETAINED static OS_TIMER hrs_timer;
...
void hrp_sensor_task(void *params)
{
        ...
        /* Set device name */
        ble_gap_device_name_set("UGA Heart rate, blood oxygen, "
                "and breathing sensor", ATT_PERM_READ);
         ...
         * is connected.
         */
        hrs_timer = OS_TIMER_CREATE("hrs", OS_MS_2_TICKS(1000), OS_TIMER_SUCCESS,
